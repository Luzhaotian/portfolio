...
2. If user only provided Chinese, mirror structure in `en.ts` (translate or temporarily copy zh).
3. Prefer replacing sample/placeholder entries rather than appending on top of the author's personal content.
4. Do not invent private facts. Use YAML values or explicit placeholders.
